...
$.jgrid.extend({
	setColumns : function(p) {
		var regional =  $.jgrid.getRegional(this[0], 'col');
		p = $.extend({
			top : 0,
			left: 0,
			width: 200,
		...
		return this.each(function(){
			...
			if ( $("#"+IDs.themodal).html() != null ) {
				...
				bF	="<a href='javascript:void(0)' id='fData' class='fm-button ui-state-default ui-corner-all'>保存设置</a>";
				
				if(p.favorUrl!=null){
					formdata += "<table border='0' class='EditTable' id='"+dtbl+"_2'><tbody><tr style='display:block;height:3px;'><td></td></tr><tr><td class='DataTD ui-widget-content'></td></tr><tr><td class='ColButton EditButton'>"+bS+"&#160;"+bC+"&#160;"+bF+"</td></tr></tbody></table>";
				...
				//mod by cx 2015-8-6绑定保存设置按键
				$("#fData", "#"+dtbl+"_2").click(function(e){
					//alert(JSON.stringify($t.p.colModel));
					var a=$t.p.colModel;
					var str=[];
